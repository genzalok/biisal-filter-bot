...
BOT_TOKEN = environ.get('BOT_TOKEN', '6897344346:AAEZ7io1zRUf7CPJWV4_uJLeEbXS0TeJm8Q')
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://filmyrip:filmyrip@filmyrip.17wpdwt.mongodb.net/?retryWrites=true&w=majority&appName=filmyrip")

DATABASE_NAME = environ.get('DATABASE_NAME', "filmyrip")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'filmyrip')
...
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002100182116'))
URL = environ.get('URL', 'mytestbot-jvdfhbj.com')
STICKERS_IDS = ('CAACAgQAAxkBAAEK99dlfC7LDqnuwtGRkIoacot_dGC4zQACbg8AAuHqsVDaMQeY6CcRojME').split()
FILE_AUTO_DEL_TIMER = int(environ.get('FILE_AUTO_DEL_TIMER', '600'))
IS_VERIFY = is_enabled('IS_VERIFY', False)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002100182116'))
TUTORIAL = environ.get("TUTORIAL", "https://t.me/FRVerfication/02")
...
REF_PREMIUM = 30
PREMIUM_POINT = 1500
auth_channel = environ.get('AUTH_CHANNEL', '-1002055602317')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1001664556478'))
request_channel = environ.get('REQUEST_CHANNEL', '-1001664556478')
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1002100182116'))
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1001819275186'))
